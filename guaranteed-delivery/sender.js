...
const dataTypeChannel = new dataTypeLib.Producer("practical.messaging.guaranteed." + greeting.constructor.name, "amqp://guest:guest@localhost:5672", function(message){
