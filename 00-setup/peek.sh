...
#
#   ./peek.sh dead.failing-well.PlaceOrder      the message and its headers
#   ./peek.sh invalid.failing-well.PlaceOrder
#   ./peek.sh dead.failing-well.PlaceOrder 3    the first three, if there are several
#
set -uo pipefail
