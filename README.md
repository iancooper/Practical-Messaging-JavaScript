...
> `localhost:` constants in `simple-messaging/channel.js` and `simple-eventing/stream.js`.
...
| `sender.js`, `receiver.js` | two console apps, plus `stream-consumer.js` in exercise 3 |
